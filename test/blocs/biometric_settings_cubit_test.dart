...
void main() {
  ...
  late MockAppLockCubit mockAppLockCubit;

  setUp(() {
    mockBiometricService = MockBiometricService();
    mockSecuritySettings = MockSecuritySettingsLocalDataSource();
    mockAppLockCubit = MockAppLockCubit();
    cubit = BiometricSettingsCubit(mockBiometricService, mockSecuritySettings, mockAppLockCubit);
  });
